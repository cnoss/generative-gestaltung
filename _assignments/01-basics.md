...
Bitte [forken](https://git.coco.study/students/ws2324/df12-generative-gestaltung/dev-environment-generative-gestaltung/-/forks/new) und klonen Sie folgendes [Starterpaket](https://git.coco.study/students/ws2324/df12-generative-gestaltung/dev-environment-generative-gestaltung). Auf der Basis werden wir die nächsten Tage arbeiten, also bitte an einen sinnvollen Platz legen ;)
