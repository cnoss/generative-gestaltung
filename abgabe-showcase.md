...
{% include functions/resolve-urls.html target="dev-environment" %}
{% assign dev-environment = link %}
...
<p>Ergänzend stellen Sie Ihr Artefakt am letzten Tag der Modulwoche, dem Freitagvormittag, im Rahmen eines gemeinsamen Rundgangs kurz persönlich vor.</p>
</div>
...
### Sie übersetzen ein Thema in eine gestalterische Form
...
### Programmieren als gestalterische Tätigkeit
...
### Sie machen Ihren eigenen Prozess sichtbar
...
### Sie vermitteln Ihre Arbeit an Dritte
...
### Vermittlungsobjekt
Eine fremde dritte Person, etwa eine Besucherin einer Ausstellung oder Kommilitone aus einem späteren Semester, soll Ihr Projekt verstehen können, ohne dass Sie daneben stehen und erklären. Diese Vermittlungsfähigkeit ist eine Kernkompetenz im gestalterischen Beruf, und sie wird hier eingeübt.
...
- einen Screenshot der die Station visuell vergegenwärtigt,
...
### Rundgang am Modulfreitag

Am Vormittag des letzten Modultags treffen wir uns zu einem gemeinsamen Rundgang, bei dem alle Artefakte kurz vorgestellt werden. Sie zeigen Ihr Artefakt live, demonstrieren die zentralen Interaktionen und ordnen in wenigen Sätzen ein, worum es geht und welchen Weg Sie dorthin genommen haben. Der Rundgang ist verbindlicher Teil der Abgabe.

Der Rundgang erfüllt zwei Funktionen: Er ist eine letzte Probe Ihrer Vermittlungsfähigkeit, diesmal nicht über die Website, sondern im direkten Gespräch. Er macht den Jahrgang als Ganzes sichtbar, sodass Sie sehen, was an Ihrer Seite entstanden ist.
...
- ein Video des finalen Sketches, das den Sketch in Aktion zeigt,
...
**Vermittlung:** Eine fremde dritte Person versteht ohne Rückfrage, was das Artefakt tut, warum es so aussieht und wie es entstanden ist. Captions sind präzise und ökonomisch, das Video setzt das Artefakt richtig in Szene. Beim Rundgang führen Sie souverän durch das Artefakt, nehmen Fragen auf und ordnen Ihre Entscheidungen sicher ein.
...
**Vermittlung:** Verständlich aufbereitet, kleine Lücken möglich. Video und Erläuterungen sind nachvollziehbar und verständlich. Beim Rundgang stellen Sie Ihr Artefakt klar vor und beantworten Rückfragen sicher.
...
**Kundenperspektive:** Ein Kunde wäre zufrieden, nähme die Arbeit ohne Diskussion ab und behielte die Kontaktdaten für den nächsten Auftrag.
...
**Vermittlung:** Das Grundprinzip wird vermittelt, Dritte hätten Rückfragen. Erzählfluss mit Lücken. Beim Rundgang gelingt die Vorstellung im Kern, Erläuterungen wirken jedoch unvorbereitet oder ungeordnet.
...
Das Case Study Website ist formal erfüllt, alle Sektionen sind da, der Sketch läuft. Die Bearbeitung bleibt jedoch auf Mindestniveau.
...
**Vermittlung:** Reicht aus, um das Artefakt zu erkennen, bleibt visuell und sprachlich hinter dem Format zurück. Beim Rundgang ist Ihr Artefakt zu sehen, die mündliche Einordnung bleibt knapp und bleibt am Sketch selbst hängen.

**Gestalterisches Repertoire:** Mindestbearbeitung des Hackday-Themas erkennbar.

**Algorithmisches Repertoire:** Funktionsfähiger Sketch auf Basis der Kursaufgaben, ohne erkennbare Erweiterung.
...
### Schlechte Lösung *(nicht bestanden)*
...
**Vermittlung:** Ohne mündliche Erläuterung nicht verständlich. Beim Rundgang ist keine Einordnung möglich, oder die Teilnahme am Rundgang findet ohne triftigen Grund nicht statt.
